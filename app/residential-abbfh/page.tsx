          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                <Image
                  src="/ABB F@H.jpeg"
                  alt="Luxury villa with smart home automation lighting and control system"
                  width={600}
                  height={400}
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                  <p className="text-white text-sm font-medium">Luxury smart home automation by Tanti Automatics</p>
                </div>
              </div>
            </motion.div>
          </div>
