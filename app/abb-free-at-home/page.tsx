...
import { ArrowRight, CheckCircle, Home, Zap, Shield, Phone, Building2, Wifi, Lock, Smartphone, Rocket, DollarSign, Plug } from "lucide-react"
...
export default function ABBFreeAtHomePage() {
  ...
  // Animation variants - use consistent initial state to prevent hydration errors
  const cardVariants = {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section - Version 2.0 - Fixed className hydration mismatch */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                <Image
                  src="/lights---philips-smaller.png"
                  alt="Wireless smart home solution interface"
                  width={600}
                  height={400}
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                  <p className="text-white text-sm font-medium">Wireless smart home switches and app control</p>
                </div>
              </div>
            </motion.div>
      ...
      <section id="comparison" className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              ABB Free@Home Solutions
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Wired vs Wireless Solutions - We help you choose what fits your needs
            </p>
          </motion.div>
          ...
          >
            <div className="relative rounded-lg overflow-hidden shadow-2xl">
              <Image
                src="/features-and-applications.png"
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                <p className="text-white text-sm font-medium">Choosing the right smart home system: Wired vs Wireless Solutions</p>
              </div>
            </div>
          </motion.div>

          <div className="grid md:grid-cols-2 gap-8">
            {/* Wireless Solution Card */}
            <motion.div
