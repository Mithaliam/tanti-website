  ...
  return (
    <section className="py-12 sm:py-16 relative" style={{ backgroundColor: '#F5F5F0' }}>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3">Success Stories</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {stories.map((story, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <p className="text-white/70 text-sm sm:text-base">{story.description}</p>
                </div>
              </div>
            </motion.div>
          ))}
